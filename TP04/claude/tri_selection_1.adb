...
procedure Tri_Selection is
    ...
    -- Objectif : Trier un tableau en ordre croissant suivant l'algorithme
    --            du tri par sélection.
    -- Paramètre :
    --    Tab : le tableau à trier (modifié en place).
    -- Principe : Pour chaque position i, on cherche le minimum dans la
    --            partie non triée [i..Taille], puis on l'échange avec
    --            l'élément en position i.
    procedure Trier(Tab: in out T_Tableau) is
        Indice_Min : Integer;
        Temp        : Integer;
    begin
        for I in 1..Tab.Taille - 1 loop
            -- Trouver l'indice du minimum dans Tab[I..Taille]
            Indice_Min := I;
            ...
            -- Échanger Tab[I] et Tab[Indice_Min] si nécessaire
    ...
    procedure Tester_Trier is
        ...
        begin
            Copie := Tab;
            Trier(Copie);  -- appel pour trier le tableau Copie
