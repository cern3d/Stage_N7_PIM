...
procedure Tableau_Supprimer is
    ...
    -- Objectif : Supprimer tous les éléments négatifs (strictement < 0) du tableau.
    -- Paramètres :
    --    Tab : le tableau à modifier (in out).
    procedure Supprimer_Negatifs (Tab: in out T_Tableau) is
        Indice_Ecriture: Integer;
    begin
        Indice_Ecriture := 1;
...
begin
    ...
    Ecrire (Tab1);
    New_Line;
    -- Supprimer toutes les éléments négatifs de Tab1
