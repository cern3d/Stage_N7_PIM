...
procedure Tri_Selection is
    ...
    -- =========================================================
    --  Instanciation du package Alea pour des entiers entre -50 et 50
    -- =========================================================
    package Alea_Entiers is new Alea (Lower_Bound => -50, Upper_Bound => 50);
    ...
    begin
        ...
        pragma Assert (Est_Trie (Copie),
                       "ECHEC : le tableau trie n'est pas en ordre croissant !");
        pragma Assert (Memes_Elements (Tab, Copie),
                       "ECHEC : le tableau trie ne contient pas les memes elements !");
    ...
    procedure Tester_Trier is
        ...
        --            tirées via le package Alea (bornes -50..50).
        ...
        begin
            Tab.Taille := N;
            for I in 1 .. N loop
                Alea_Entiers.Get_Random_Number (Tab.Elements (I));
            end loop;
