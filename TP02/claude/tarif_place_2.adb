...
--      AFFICHER "Veuillez entrer l'âge du spectateur :"
--      SAISIR age

--      // 2. Déterminer le tarif en fonction de l'âge
--      SI age < 14 ALORS
--          tarif <- 7.0
...
--      AFFICHER "Le tarif de la place est de : ", tarif, " €"
--  FIN